const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwYHfZt9iuJhX_uZgudGEZC2Iqf708eScH8zhaFQJswBFS3f5DblaYTuZaW03Rn9yStmA/exec';
        ...
        const PLANTA_ORDER = ['COFACO', 'CITI1', 'CITI2', 'CITI3', 'CITI4'];
        const PLANTA_TOTAL_FILTERS = ['COFACO', 'CITI1', 'CITI2', 'CITI3', 'CITI4', PLANTA_FILTER_OTHERS];
        ...
        const OC_SEARCH_PLANT_ORDER = ['COFACO', 'CITI1', 'CITI2', 'CITI3', 'CITI4', PLANTA_FILTER_OTHERS];
        ...
        async function saveLineaModalChanges() {
            ...
            lineaModalRefs.btnSave.disabled = true;
            lineaModalRefs.btnCancel.disabled = true;
            lineaModalRefs.planta.disabled = true;
            lineaModalRefs.linea.disabled = true;

            try {
                if (hasPlantaChange) {
                    await saveCellToSheet(meta, 'PLANTA', nextPlanta);
                    updateLocalRowValue(meta.rowIndex, 'PLANTA', nextPlanta);
                }
                if (hasLineaChange) {
                    await saveCellToSheet(meta, 'LINEA', nextLinea);
                ...
                alert('No se pudo guardar Planta/Linea.');
                lineaModalRefs.btnSave.disabled = false;
                lineaModalRefs.btnCancel.disabled = false;
                lineaModalRefs.planta.disabled = false;
                lineaModalRefs.linea.disabled = false;
            }
        }
